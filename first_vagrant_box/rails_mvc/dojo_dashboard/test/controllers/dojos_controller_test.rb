...
class DojosControllerTest < ActionController::TestCase
  ...
  test "should create dojo" do
    assert_difference('Dojo.count') do
      post :create, dojo: { branch: @dojo.branch, city: @dojo.city, state: @dojo.state, street: @dojo.street }
    end
  ...
  test "should update dojo" do
    patch :update, id: @dojo, dojo: { branch: @dojo.branch, city: @dojo.city, state: @dojo.state, street: @dojo.street }
    assert_redirected_to dojo_path(assigns(:dojo))
  end
